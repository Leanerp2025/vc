                            ...
                            <div class="item-card">
                                <div class="item-card-header">
                                    ...
                                    <div class="item-card-actions">
                                        <a href="folder_details.php?id=<?php echo htmlspecialchars($folder['id']); ?>" class="arrow-icon" title="Open"><span class="material-symbols-outlined">arrow_forward</span></a>
